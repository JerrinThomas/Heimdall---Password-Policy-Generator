<html>
<head>
<title>Dynamic Salt Test Login</title>
</head>  
<body>
...
<?php
    ...
    $sql="SELECT uid,logintime FROM name_time_warehouse WHERE uname='$name'";
    ...
    $sql="SELECT hashval FROM hash_warehouse WHERE uid='$id[0]'";
    $result=mysqli_query($dbC,$sql);
